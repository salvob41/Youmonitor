...
def get_comments(youtube, video_id, channel_id, next_page):
    ...
    next_page_token = results["nextPageToken"] if "nextPageToken" in results else False

    return results["items"], next_page_token
...
if __name__ == "__main__":
    ...
    try:
        ...
        while next_page is not False:
            video_comments,next_page = get_comments(youtube, args.videoid, None, next_page)
            counter += len(video_comments)
        #if video_comments:
